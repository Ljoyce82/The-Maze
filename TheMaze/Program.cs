...
namespace TheMaze
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
                ...
                {
                    Console.SetWindowSize(Console.WindowWidth * 1, Console.WindowHeight * 1);
                ...
                static void LoadSavedGame() //can not get it to stop looping back to menu if player loads there save file.
                {
                    currentPlayer = SaveSystem.LoadPlayer() ?? new Player();
